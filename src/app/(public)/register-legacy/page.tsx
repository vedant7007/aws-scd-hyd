...
/**
 * PARKED. The multi-step registration and UPI payment flow, kept whole and
 * working but unlinked from every public page while REGISTRATION_OPEN is
 * false and the new flow is being decided. /register is the notify page.
 *
 ...
 */
export default async function RegisterLegacyPage({ searchParams }: PageProps<'/register-legacy'>) {
